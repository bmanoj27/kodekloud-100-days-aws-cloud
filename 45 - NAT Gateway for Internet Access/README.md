...
3) The EC2 instance is configured with a cron job that uploads a test file to a bucket nautilus-nat-26354 once internet is accessible.
...
Once complete, verify that the EC2 instance can reach the internet by confirming the presence of the test file in the S3 bucket nautilus-nat-26354. After completing all the configuration, please wait a few minutes for the test file to appear in the bucket, as it may take 2–3 minutes.